<template>
	<div>
		<section>
			...
			<progress class="progress is-warning is-large" :value="countItems" max="107">{{ countItems }}</progress>
		</section>
		...
		<section>
			<center>
				<div v-if="countItems >= 1">
					<br>
					<b-button type="is-primary" size="is-large" @click="submit">Αξιολογήστε τα ενδιαφέροντά μου</b-button>
				</div>
			</center>
		</section>
	</div>
