<template>
	<div>
		<div class="container">
			...
			<h1 class="title has-text-centered">Τεστ ικανοτήτων</h1>
		...
		<div class="main-application">
			<b-tabs type="is-toggle"  v-model="activeTab" expanded>
          	...
          	<div v-if="!!formName && countItems == 107">
			<!-- <div v-if="countItems == 100"> -->
					...
					<div v-else >
						...
						<h2 class="is-size-3 has-text-weight-medium has-text-centered">Λείπουν {{ 107 - countItems }} ερωτήσεις.</h2>
